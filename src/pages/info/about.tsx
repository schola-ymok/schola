...
const About = () => (
  <Container maxWidth='sm' sx={{ mt: 10 }}>
    ...
    <Box sx={{ fontSize: '1.1em', mt: 5 }}>
      Scholaは現代の学びに適した新しい学習テキストのマーケットプレイスです。個々人が持っている様々な経験や知識をテキスト化し販売できる場を通じて社会に埋もれている知見を形式化します。
    </Box>

    <Box sx={{ fontSize: '1.1em', my: 5 }}>
      進学や就職、転職、退職など人生におとずれた転機で新たな領域へ一歩踏み出そうとしている人を支えるためにScholaは存在します。また、Scholaでの学びは個々人がこのような転機を自ら創り出すことを促し、社会全体の進歩を加速させていきます。
    </Box>
  </Container>
);
